...
public class CourseController {
    ...
    public String catalog(
            ...
            @RequestParam(value = "s", required = false) String sort, Model model, HttpSession session
    ) {
        if (userDetails != null) {
    ...
    @GetMapping
    @PreAuthorize("@courseServiceImpl.isPrivate(#id) ? hasRole('ROLE_ADMIN') || @courseServiceImpl.isValidAccessCode(#id, #accessCode) " +
    ...
    public String getById(@RequestParam("id") Long id, @RequestParam(value = "access_code", required = false) String accessCode,
                          @AuthenticationPrincipal UserDetails userDetails, Model model, HttpSession session) {
    ...
    @PreAuthorize("@userServiceImpl.isCourseFollower(authentication.principal.id, @courseServiceImpl.getById(#id)) " +
            "|| @userServiceImpl.isCourseOwner(authentication.principal.id, #id)")
    public String learning_process(@RequestParam("id") Long id, @AuthenticationPrincipal UserDetails userDetails,
